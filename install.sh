...
export PERL_CPANM_OPT="--mirror-only --mirror http://cpan.org -l $GRS_ROOT_LIB -L $GRS_ROOT_LIB -nq --self-contained"
...
curl -sL http://cpanmin.us/ | /usr/bin/perl - -v App::local::lib::helper IO::Socket::SSL LWP::Protocol::https Redmine::API Moo MooX::Options Version::Next DateTime Term::ReadLine Date::Parse LWP::UserAgent List::MoreUtils List::Util List::Util::XS autodie utf8::all Term::Size Digest::MD5 Data::UUID JSON::XS URI::Escape IO::Interactive REST::Client URI DDP Data::Record Regexp::Common
